...
export default function AdminInnerWorkspacePage() {
  ...
  const innerId = router.query.innerId as string ?? "Unknown";
  const queryId = formatQueryValue(router.query.id as string);
  const queryName = formatQueryValue(router.query.name as string);
